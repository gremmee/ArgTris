...
public class Board extends JPanel implements ActionListener {
    ...
    class ArgtrisAdapter extends KeyAdapter {
        @Override
    ...
    public Board(ArgTris aParent) {
        ...
        clearBoard();
        addKeyListener(new ArgtrisAdapter());
    }
    ...
    public Tetrominos shapeAt(int aX, int aY) {
    ...
    private void settextStatusBar(String aText) {
        statusBar.setText(
                aText + "Lines: " + String.valueOf(numLinesRemoved) + " - Argtris: " + String.valueOf(numArgtris)
